...
srun -n 16 ./hello >> my_output_fil
srun -n 16 ./piblockin >> my_output_piBlockParallel
srun -n 16 ./pinonblockin >> my_output_pi_parallel_nonblocking
srun -n 16 ./pibinaryreduc >> my_output_piBinaryTReduc
