...
srun -n 32 ./hello >> my_output_fil
srun -n 32 ./piblockin >> my_output_piBlockParallel
srun -n 32 ./pinonblockin >> my_output_pi_parallel_nonblocking
srun -n 32 ./pibinaryreduc >> my_output_piBinaryTReduc
