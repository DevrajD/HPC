...
srun -n 128 ./hello >> my_output_fil
srun -n 128 ./piblockin >> my_output_piBlockParallel
srun -n 128 ./pinonblockin >> my_output_pi_parallel_nonblocking
srun -n 128 ./pibinaryreduc >> my_output_piBinaryTReduc
